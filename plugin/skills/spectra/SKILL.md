---
name: spectra
description: Govern frontier sessions — route scout and boilerplate to cheap subagents, require approval for frontier calls, stop on budget. Use when Codex or Claude would burn tokens doing search or grunt work itself.
license: MIT
---

# Spectra (governor)

You are the **decider**, not the whole workforce. Codex or Claude stays on this thread for planning and final calls. Everything else goes to **lower-tier subagents**.
